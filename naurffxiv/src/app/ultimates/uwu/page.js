...
import TableOfContents from "@/app/common/toc/page";

export default function UWU() {
    const [tabs, setTabs] = useState(["Quick Reference", "Garuda", "Ifrit", "Titan", "Intermission", "Ultima"]);
    const [selectedTab, setSelectedTab] = useState("Quick Reference");
